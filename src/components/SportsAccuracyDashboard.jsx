...
import { Upload, Target, Rocket, BarChart3, RefreshCcw, Settings2, Filter, Brain, MessageSquare } from "lucide-react";
...
// AI Components
import AICoachingPanel from "./AICoachingPanel.jsx";
import AIChatInterface from "./AIChatInterface.jsx";
import OpenWebUISettings from "./OpenWebUISettings.jsx";
...
export default function SportsAccuracyDashboard() {
  ...
  const [openwebuiSettings, setOpenwebuiSettings] = useState(null);
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {showSettings && (
          <div className="max-w-2xl mx-auto">
            <OpenWebUISettings 
              onSettingsUpdate={setOpenwebuiSettings}
            />
          </div>
        )}
